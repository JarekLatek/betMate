...
| Plik | Opis |
|------|------|
| `supabase/functions/sync-matches/index.ts` | Synchronizacja danych z api-football.com |
...
- Synchronizacja: ręczna przez CLI lub automatyczna (cron co 2h)
- Uwaga: Darmowy plan API obsługuje tylko sezony 2021-2023
...
- [ ] Konfiguracja cron dla Edge Function w produkcji
